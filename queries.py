...
############################# TO DO #####################################
    ...
    master_query = "SELECT * FROM invoices JOIN customers ON invoices.customer_id = customers.id "

    #### create outdoors_query variable

    outdoors_query = "SELECT * FROM invoices JOIN customers ON invoices.customer_id = customers.id WHERE invoices.product_category = 'Outdoors'"

    #### create garden_query variable

    garden_query = "SELECT * FROM invoices JOIN customers ON invoices.customer_id = customers.id WHERE invoices.product_category = 'Garden'"

    #### create product_revenue variable

    product_revenue_query = "SELECT product_category, SUM(unit_price*quantity) FROM invoices GROUP BY product_category ORDER BY SUM DESC"
